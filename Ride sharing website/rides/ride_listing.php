...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($waypoints !== false) {
        ...
        $user_name = $user_data['username']; // Assuming 'id' is the primary key of the 'users' table
        ...
        $sql = "INSERT INTO trip_listing (user_id,username, origin, destination, waypoint,seats) VALUES ('$user_id','$user_name' ,'$origin', '$destination', '$all_waypoints','$seats')";
        if (mysqli_query($con, $sql)) {
            echo "ride listed successfully!<br>";
        } else {
            echo "Error listing ride: " . mysqli_error($con) . "<br>";
        }
    } else {
