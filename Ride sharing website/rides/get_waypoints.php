...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $female_only = isset($_POST['femaleOnly']) ? 1 : 0;
    ...
    if ($waypoints !== false) {
        ...
        $sql = "INSERT INTO search_trip (user_id, origin, destination, waypoint,female_only) VALUES ('$user_id', '$origin', '$destination', '$all_waypoints','$female_only')";
