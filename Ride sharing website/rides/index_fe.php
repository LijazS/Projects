...
<head>
    ...
    <link href="css/webflow-style_2.css" rel="stylesheet" type="text/css" />
                ...
                <div class="container">
                    <div class="div-block">
                        <nav role="navigation" class="nav-menu-wrapper w-nav-menu">
                            ...
                            <li><a href="index_fe.php" class="nav-link">Home</a></li>
    ...
    <section class="pricing-overview">
        <div class="container">
            ...
            <div class="pricing-grid">
                <div id="w-node-_2bda493d-21fc-326b-af38-25fee1a5f1f9-cbce147f" class="text-block">Need a ride?
                    <br /><br />Explore available options from drivers heading your way</div>
                <div id="w-node-d1e78cd5-844b-4c44-f133-6b4b42fac7d0-cbce147f" class="pricing-card-three">
                    <div class="w-form">
                        <form id="email-form-2" name="email-form-2" data-name="Email Form 2"  action="get_waypoints.php" method="POST" class="form"
                            data-wf-page-id="6629e1feefef0981cbce147f"
                            data-wf-element-id="e008b9d4-9298-d737-30f9-5fe92a3d7fff">      <!--FORM HERE-->
                            ...
                            <div class="div-block-3"><img src="images/location.png" loading="lazy"
                                ...
                                <div id="w-node-d326b215-1f23-f4e7-5373-d44aff150ab1-cbce147f" class="text-block-2">
                                    Starting Trip :</div>
                            </div><input type="text" id="origin" name="origin" data-name="Field" class="select-field w-select">
                            ...
                            <div class="div-block-3"><img src="images/location.png" loading="lazy"
                                ...
                                <div id="w-node-_4410b993-acc4-0968-2d55-75bcb4897f5d-cbce147f" class="text-block-2">
                                    Ending Trip :</div>
                            </div><input type="text" id="destination" name="destination" data-name="Field 2" class="select-field w-select">
                            ...
                            <div class="div-block-3-copy-copy"><img src="images/calendar.png" loading="lazy"
                                ...
                                <div id="w-node-_7751a090-f8fc-96b3-47cc-3c57586140a3-cbce147f"
                                    class="text-block-2-copy">Date :</div>
                                    
                                    <img src="images/clock.png" loading="lazy"
                            ...
                            <div class="div-block-6"><input id="field-2" type="date" name="field-2" data-name="Field 2"
                               ...
                               <input type="time" id="field-2" name="field-2" data-name="Field 2"
                                 ...
                                 <label class="w-checkbox checkbox-field"><input type="checkbox" value="1"
                                    id="femaleOnly" name="femaleOnly" data-name="femaleOnly"
                                    class="w-checkbox-input checkbox" /><span class="checkbox-label w-form-label"
                                    for="femaleOnly">Request only Lady Drivers</span></label>
                                    <button type="submit" style="transform: translateY(30px)"class="button-primary w-button">SEARCH TRIPS</button>
                        </form>
                        <div class="w-form-done">
                            <div>Thank you! Your submission has been received!</div>
                        </div>
